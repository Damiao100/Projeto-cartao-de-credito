...
## Observações:
- Utiliza a classe Scanner para fazer a leitura das informações do usuário;
- Utiliza construtores nas classes para passar as informações ao instanciar um objeto.
